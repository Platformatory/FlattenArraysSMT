package com.platformatory.connect.quickstart.predicate;

import com.platformatory.connect.quickstart.predicates.EqualsField;
...
public class EqualsFieldTest {
    ...
    private static final String RECORD_NAME = "com.platformatory.connect.quickstart.Record";
